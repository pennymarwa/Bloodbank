...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2016 at 01:50 PM
...
INSERT INTO `banks` (`id`, `Bank_Name`, `Contact_Person`, `Address`, `Location`, `Pin_Code`, `Phone`, `Mobile`, `E_Mail`) VALUES
(1, 'Red-Cross-Regional-Blood-Bank', 'Ram sharma', 'Red Cross Bhawan, Mall Rd, Bharat Nagar, Ludhiana - 141001, Nr Bharat Nagar Chowk', 'ludhiana punjab india', '141001', '1612441257', '1612441257', 'ram@gmail.com'),
(3, 'SNS Pahwa hospital blood bank', 'ravi verma', 'industrial area-b ludhiana', 'ludhiana punjab india', '141003', '01612534181', '1612534181', 'ravi@gmail.com'),
(4, 'Shri Krishna charitable hospital', 'raman singh', 'Model Town ,pritam nagar ,ludhiana', 'ludhiana punjab india', '141002', '01612428060', '01612428060', 'raman@gmail.com'),
(5, 'DMC hospital', 'Aman Verma', 'Civil Line', 'ludhiana', '141003', '5026999', '2643171', 'aman@yahoo.in'),
(6, 'DMC hospital', 'Aman Verma', 'Civil Line', 'ludhiana', '141003', '5026999', '2643171', 'aman@yahoo.in');
...
--
-- Table structure for table `donar1`
--
...
CREATE TABLE `donar1` (
  ...
  `Donate` varchar(225) NOT NULL,
  `B_Group` varchar(225) NOT NULL,
  `Any_problem` varchar(225) NOT NULL,
  `Thalassemia` varchar(225) NOT NULL,
  `Types` varchar(225) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `donar1`
--

INSERT INTO `donar1` (`id`, `Name`, `Gender`, `Contact`, `Email`, `Address`, `Location`, `Age`, `Weight`, `Donate`, `B_Group`, `Any_problem`, `Thalassemia`, `Types`) VALUES
(1, 'Amrinder', 'Male', '8654345678', 'amrinder@gmail.com', 'dugri', 'Ludhiana, Punjab, India', '40', '70', '', 'A+', 'no', 'no', '');
...
CREATE TABLE `events` (
  ...
  `Organisation_name` varchar(225) NOT NULL,
...
INSERT INTO `events` (`id`, `Event_Name`, `Organisation_name`, `Venue`, `Time`, `Date`, `Description`, `img`) VALUES
(1, 'Blood donation camp', 'Rotary clubs', 'ludhiana', '23:00', '2016-05-01', 'Club has organised a camp for blood donation', 'rotary clubs.png'),
(2, 'Donation request', 'Rotary club', 'GNE', '14:00', '2016-05-03', 'please join the event', 'image111.jpg'),
(3, 'Blood donation camp', 'Rotary club', 'GNE', '23:00', '2016-05-12', 'Club has organised a camp for blood donation', 'index12.jpg');
...
INSERT INTO `news` (`id`, `img`, `News`, `Date`, `Description`) VALUES
(3, '477847-rss.jpg', 'Kallam temple fire :RSS volunteers throng hospital to donate blood for victims;pictures go viral', '2016-04-11', 'kjkjkjk'),
(4, 'Untitled.png', 'lifesaver', '2016-02-12', 'Meet the lifesaver from hyderabad who donated blood 111 times'),
(5, 'blood.jpg', 'donate blood for heart surgery', '2016-03-02', 'heart surgery patients receiving newly donated blood have significantly fewer post-operative complications.');

-- --------------------------------------------------------

--
-- Table structure for table `new_comment`
--
...
INSERT INTO `ngo` (`id`, `Organisation_Name`, `Owner_Name`, `Description`, `Email`, `Address`, `Location`, `Phone`, `Mobile`, `Password`, `img`) VALUES
(2, 'RAMESHWAR WELFARE TRUST', 'Amit Khurana', 'Health & Family Welfare,Human Rights, Legal Awareness', 'rwtludhiana@gmail.com', 'RAMESHWAR WELFARE TRUST (REGD.) 2040/9B JAIN NAGR SHIV PURI LUDHIANA 141008 PUNJAB INDIA\r\n', 'Ludhiana, Punjab, India', '01612746628', '09256371085', '1111', 'Rameshwar.jpg'),
(3, 'GURU GOBIND SINGH STUDY CIRCLE', 'Ram Singh', 'Health & Family Welfare,Human Rights, Legal Awareness', 'info@ggssc.net', 'Model Town Extension Ludhiana 141002\r\n', 'Ludhiana, Punjab, India', '01612450352', '01614610145', '1111', 'guru.jpg'),
(4, 'NATIONAL FORUM FOR CONSUMER RIGHTS', 'Dr Ajay Shahi', 'Pioneered in providing Consumer Education in Ludhiana and surrounding areas particularly in Schools, Colleges, Clubs and among social organizations by holding seminars, workshops, conferences and on the spot checks. Instrumental in busting adulteration in milk products, LPG gas cylinders, petroleum products, edible items, washing powders and soaps. Preventing illegal sale of tickets at various social events. Resolved many fraudulent credit card, bank charges, cellular companies, electronic companies complaitns and matters.', 'nfcrindia@yahoo.com', '1444, Urban Vihar, Adj. Ph-1, Urban Estate, Dugri, Ludhiana - 141 013\r\n', 'Ludhiana, Punjab, India', '1612492276', '9779376000', '1111', 'download.png');
...
INSERT INTO `register` (`id`, `Name`, `Gender`, `Contact`, `Email`, `Address`, `Location`, `B_group`, `Disease`, `Age`, `Weight`, `Password`) VALUES
(1, 'Amrinder', 'Male', '8654345678', 'amrinder@gmail.com', 'dugri', 'Ludhiana, Punjab, India', 'A+', '', '40', '70', '1111');
...
ALTER TABLE `cities`
  ...
  ADD UNIQUE KEY `unq` (`countryID`,`stateID`,`cityID`),
  ADD KEY `cityName` (`cityName`),
  ADD KEY `stateID` (`stateID`),
  ADD KEY `countryID` (`countryID`),
  ADD KEY `latitude` (`latitude`),
  ADD KEY `longitude` (`longitude`),
  ADD KEY `countrystate` (`countryID`,`stateID`),
  ADD KEY `countrycity` (`countryID`,`cityID`);
...
ALTER TABLE `states`
  ...
  ADD KEY `countryID` (`countryID`),
  ADD KEY `unq1` (`countryID`,`stateName`);
...
--
ALTER TABLE `cities`
  MODIFY `cityID` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79675;
--
...
--
-- AUTO_INCREMENT for table `donar1`
--
ALTER TABLE `donar1`
...
--
-- AUTO_INCREMENT for table `new_comment`
--
ALTER TABLE `new_comment`
  MODIFY `id` int(225) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `states`
  MODIFY `stateID` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2371;
